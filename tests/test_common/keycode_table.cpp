...
std::map<uint16_t, std::string> KEYCODE_ID_TABLE = {
    ...
    {QK_KEY_CANCELLATION_RECOVERY_ON, "QK_KEY_CANCELLATION_RECOVERY_ON"},
    {QK_KEY_CANCELLATION_RECOVERY_OFF, "QK_KEY_CANCELLATION_RECOVERY_OFF"},
    {QK_KEY_CANCELLATION_RECOVERY_TOGGLE, "QK_KEY_CANCELLATION_RECOVERY_TOGGLE"},
    {QK_KB_0, "QK_KB_0"},
    {QK_KB_1, "QK_KB_1"},
    {QK_KB_2, "QK_KB_2"},
    {QK_KB_3, "QK_KB_3"},
