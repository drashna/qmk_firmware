...
__attribute__((weak)) led_index_t rgb_matrix_led_index(led_index_t index) {
#if defined(RGB_MATRIX_SPLIT)
...
void rgb_matrix_set_color(led_index_t index, uint8_t red, uint8_t green, uint8_t blue) {
