...
#define DUAL_ROLE_TAP_DANCE_LAYER_MOVE(kc, layer) {kc, layer, layer_move}

#define DUAL_ROLE_TAP_DANCE_LAYER_TOGGLE(kc, layer) {kc, layer, layer_invert}
