...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {[0] = LAYOUT_left_handed(KC_MUTE, KC_MPLY, KC_PMNS, KC_PAST, KC_PSLS, MO_NLCK, KC_P7, KC_P8, KC_P9, KC_PPLS, KC_P4, KC_P5, KC_P6, KC_P1, KC_P2, KC_P3, KC_PENT, KC_PDOT, KC_P0), [1] = LAYOUT_left_handed(RESET, _______, RGB_TOG, RGB_RMOD, RGB_MOD, _______, _______, RGB_VAD, RGB_VAI, _______, RGB_HUD, RGB_HUI, _______, _______, RGB_SAD, RGB_SAI, _______, _______, _______)};
