...
#define LAYOUT_kyria_base( \
  ...
  LAYOUT_wrapper( \
      KC_ESC,  K01,     K02,     K03,     K04,     K05,    KC_DOWN, KC_UP, KC_LEFT, KC_RIGHT,       K06,     K07,     K08,     K09,     K0A,     KC_MINS, \
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAMEPAD] = LAYOUT_wrapper(
        KC_ESC,  KC_K,    KC_Q,    KC_W,    KC_E,    KC_R,        KC_DOWN, KC_UP, KC_LEFT, KC_RIGHT,                                          _______, _______, _______, _______, _______, _______,
    ...
    [_DIABLO] = LAYOUT_wrapper(
        KC_ESC,  KC_S,    KC_I,    KC_F,    KC_M,    KC_T,         KC_DOWN, KC_UP, KC_LEFT, KC_RIGHT,                                         KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NO,   KC_NO,
    ...
    [_LOWER] = LAYOUT_wrapper(
        KC_F12,  _________________LOWER_L1__________________,      KC_DOWN, KC_UP, KC_LEFT, KC_RIGHT,                                         _________________LOWER_R1__________________, KC_F11,
    ...
    [_RAISE] = LAYOUT_wrapper(
        KC_F12,  _________________RAISE_L1__________________,       KC_DOWN, KC_UP, KC_LEFT, KC_RIGHT,                                        _________________RAISE_R1__________________, KC_F11,
    ...
    [_ADJUST] = LAYOUT_wrapper(
        KC_MAKE, _________________ADJUST_L1_________________,         KC_DOWN, KC_UP, KC_LEFT, KC_RIGHT,                                      _________________ADJUST_R1_________________, KC_RESET,
