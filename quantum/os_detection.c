...
static volatile struct usb_device_state current_usb_device_state  = {.configure_state = USB_DEVICE_STATE_INIT};
static struct usb_device_state          reported_usb_device_state = {.configure_state = USB_DEVICE_STATE_INIT};
