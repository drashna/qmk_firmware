...
#    define LED_INDICATORS_FACTORY led_matrix_indicators_factory
...
__attribute__((weak)) bool led_matrix_indicators_factory(void) { return true; }
#endif

#ifdef RGB_MATRIX_ENABLE
#    define LED_DRIVER rgb_matrix_driver
#    define LED_INDICATORS_KB rgb_matrix_indicators_kb
#    define LED_INDICATORS_FACTORY rgb_matrix_indicators_factory
...
#    else
#        define LED_DRIVER_DISABLE_TIMEOUT_SET(x)
#        define LED_DRIVER_DISABLE_TIME_RESET()
#    endif
__attribute__((weak)) bool rgb_matrix_indicators_factory(void) { return true; }
#endif
