...
#    include "bluetooth/factory_test.h"
#endif
...
bool dip_switch_update_kb(uint8_t index, bool active) {
    dip_switch_update_factory(index, active);
    if (index == 0) {
...
#if defined(KC_BLUETOOTH_ENABLE) && defined(ENCODER_ENABLE) && defined(ENCODER_DRIVER_INERRUPT)
