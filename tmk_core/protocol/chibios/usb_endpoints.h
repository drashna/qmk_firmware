...
#if !defined(MULTI_AXIS_CONTROLLER_IN_CAPACITY)
#    define MULTI_AXIS_CONTROLLER_IN_CAPACITY USB_DEFAULT_BUFFER_CAPACITY
#endif
...
typedef enum {
    ...
    USB_ENDPOINT_IN_MULTI_AXIS_CONTROLLER,
#endif
...
#    if defined(MULTI_AXIS_CONTROLLER_SHARED_EP)
    USB_ENDPOINT_IN_MULTI_AXIS_CONTROLLER = USB_ENDPOINT_IN_SHARED,
#    endif
