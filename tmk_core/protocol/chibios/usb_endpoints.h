...
#if !defined(RADIAL_DIAL_IN_CAPACITY)
#    define RADIAL_DIAL_IN_CAPACITY USB_DEFAULT_BUFFER_CAPACITY
#endif
...
#  if defined(RADIAL_DIAL_SHARED_EP)
    USB_ENDPOINT_IN_RADIAL_DIAL = USB_ENDPOINT_IN_SHARED,
#    endif
