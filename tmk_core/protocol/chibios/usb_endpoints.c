...
// clang-format off
    ...
    QMK_USB_REPORT_STORAGE(
        ...
        QMK_USB_REPORT_STROAGE_ENTRY(REPORT_ID_MULTI_AXIS_CONTROLLER, sizeof(report_multi_axis_controller_t)),
#endif
...
// clang-format on
    ...
    [USB_ENDPOINT_IN_MULTI_AXIS_CONTROLLER] = QMK_USB_ENDPOINT_IN(USB_EP_MODE_TYPE_INTR, MULTI_AXIS_CONTROLLER_EPSIZE, MULTI_AXIS_CONTROLLER_IN_EPNUM, MULTI_AXIS_CONTROLLER_IN_CAPACITY, NULL, QMK_USB_REPORT_STORAGE_DEFAULT(sizeof(report_multi_axis_controller_t))),
#endif
...
#if defined(MULTI_AXIS_CONTROLLER_ENABLE) && !defined(MULTI_AXIS_CONTROLLER_SHARED_EP)
    [MULTI_AXIS_CONTROLLER_INTERFACE] = USB_ENDPOINT_IN_MULTI_AXIS_CONTROLLER,
#endif
